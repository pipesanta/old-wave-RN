        ...
        <>
            <ScrollView>
                ...
                <View style={{ ...styles.marginContainer, ...styles.locationContainer }}>
                    ...
                    <Text style={{ ...styles.subTitle }}> {productFull.city?.name}</Text>
                </View>

                <View style={{ ...styles.marginContainer, marginTop: 0 }}>
                    <Text style={styles.title}>{productFull.name}</Text>
            ...
            <View style={styles.priceContainer} >
                <View style={styles.subcontainerPrice}>
                    <Text style={styles.textPrice}>
                        {currencyFormatter.format(productFull.price, { code: 'COP', precision: 0 })}
                    </Text>
                    <Text style={styles.subtextPrice}>
                        hasta 1x de {currencyFormatter.format(productFull.price, { code: 'COP', precision: 0 })}
                    </Text>
                </View>
